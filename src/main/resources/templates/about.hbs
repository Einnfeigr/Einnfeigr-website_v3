{{#partial "content" }}
	...
	<p>
		{{i18n "features.seamlessness.description.1" bundle="text/about" locale=locale}}<br>
	...
	<p>
		{{i18n "features.i18n.description.1" bundle="text/about" locale=locale}}<br>
	...
	<p>
		{{i18n "features.themes.description.1" bundle="text/about" locale=locale}}<br>
		{{i18n "features.themes.description.2" bundle="text/about" locale=locale}}<br>
	...
	<p>
		{{i18n "features.dropbox.description.1" bundle="text/about" locale=locale}}<br>
		{{i18n "features.dropbox.description.2" bundle="text/about" locale=locale}}
	</p>
	
	<h3>{{i18n "features.tracking.header" bundle="text/about" locale=locale}}</h3>
	<p>
		{{i18n "features.tracking.description.1" bundle="text/about" locale=locale}}<br>
		{{i18n "features.tracking.description.2" bundle="text/about" locale=locale}}
	</p>
